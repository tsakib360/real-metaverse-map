    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
        <div class="modal-content">
            <div class="sc-iwsKbI lvHJA">
                <div class="FitText text-center" style="max-height: 51px; padding: 0px 15px; text-align: center; overflow: hidden; font-size: 22px;">profile</div>
{{--                <h5 class="modal-title" id="staticBackdropLabel">Modal title</h5>--}}
{{--                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>--}}
            </div>
            <div class="modal-body p-0">
                <div class="ztOIu">Player Status</div>
                <div class="sc-dHIava jCmHFN px-2">
                        ...
                        <div class="inner-wrapper">
                            <div class="avatar Explorer" id="" style="z-index: 2; transform: scale(0.78); --explorer-color:#05DD66;">
                                <div class="image-container">
                                    <img src="https://static.upland.me/avatars/exclusive/FIFA_Field.svg" alt="explorer">
                    ...
                    <div class="sc-jhaWeW kvCPjb">
                        <div role="button" class="sc-bSbAYC jaTsI">Send UPX</div>
                    </div>
                </div>
                <div class="sc-cMljjf kRORPR">Meta Para Home address</div>
                <div class="sc-jWxkHr cWsPYI">
                    <div class="sc-daURTG dYtXpm home-address">
                        <div class="image-wrapper">
                            <div class="sc-epnACN hfUoNm">
                                <img alt="" src="https://static.upland.me/3d-models/town_house_new/town_baked.png?d=100x100" width="58" class="sc-hXRMBi eRaMsh">
                            </div>
                        </div>
                        <div class="text-wrapper">
                            <a class="link" href="/?prop_id=81480817404449">620 W 230TH ST</a>
                            <div class="sub-title">Bronx, NY</div>
                            <div class="additional-info">SPUYTEN DUYVIL</div>
                        </div>
                    </div>
                </div>
                <div color="#05DD66" class="sc-hkbPbT hNZHwU">
